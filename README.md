...
<!-- INDEX:START -->
_125 examples · 22 with ATK/VULN security assessments. Generated by `tools/build-index.php` — do not edit by hand._

| FT | Example | Pattern | Sec | Howto |
|----|---------|---------|-----|-------|
| — | [ratelog](./ratelog/) | Sliding-Window Rate Limiter | 🛡️ | [sliding-window-rate-limiter](https://github.com/hideyukiMORI/NENE2/blob/main/docs/howto/sliding-window-rate-limiter.md) |
...
| 352 | [reorderlog](./reorderlog/) | Bulk Reorder (Drag-and-Drop Ordering) | 🛡️ | [bulk-reorder-api](https://github.com/hideyukiMORI/NENE2/blob/main/docs/howto/bulk-reorder-api.md) |
<!-- INDEX:END -->
