...
use PriceLog\Price\PriceRepository;
use PriceLog\Price\PriceService;
use PriceLog\Price\RouteRegistrar;
...
class AppFactory
{
    public static function createSqlite(string $dbFile, string $adminKey = ''): RequestHandlerInterface
    {
        ...
        $repo = new PriceRepository($executor);
        $service = new PriceService($txManager);
