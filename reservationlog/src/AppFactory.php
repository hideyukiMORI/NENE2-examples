...
use ReservationLog\Reservation\ReservationRepository;
use ReservationLog\Reservation\RouteRegistrar;
...
class AppFactory
{
    public static function createSqlite(string $dbFile, string $adminKey = ''): RequestHandlerInterface
    {
        ...
        $repo = new ReservationRepository($executor);
