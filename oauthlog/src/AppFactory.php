...
use OAuthLog\OAuth\MockOAuthProvider;
use OAuthLog\OAuth\OAuthRepository;
use OAuthLog\OAuth\RouteRegistrar;
...
class AppFactory
{
    ...
    private static function build(DatabaseConfig $dbConfig): RequestHandlerInterface
    {
        ...
        $repo     = new OAuthRepository($executor);
        $provider = new MockOAuthProvider();
        $json     = new JsonResponseFactory($psr17, $psr17);
        $registrar = new RouteRegistrar($repo, $provider, $json);
